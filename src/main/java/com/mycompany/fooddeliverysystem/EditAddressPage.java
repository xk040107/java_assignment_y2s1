...
public class EditAddressPage extends javax.swing.JFrame {
    private static String customerName;
    public EditAddressPage(String customerName) {
        initComponents();
...
// Method to load the Home Address for the logged-in user
    ...
    String newHomeAddress = newAddressField.getText().trim();
    ...
    if (updateWorkAddressInFile(customerName, newHomeAddress)) {
        JOptionPane.showMessageDialog(this, "Work address updated successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
        currentAddress.setText(newHomeAddress); // Update the displayed current address
    } else {
        JOptionPane.showMessageDialog(this, "Error updating work address.", "Error", JOptionPane.ERROR_MESSAGE);
    }
} 

private boolean updateWorkAddressInFile(String username, String newHomeAddress) {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (line.startsWith("Username: ") && line.substring(10).equals(username)) {
                ...
                writer.write("Home Address: " + newHomeAddress + System.lineSeparator());
                isUpdated = true;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAddressPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAddressPage(customerName).setVisible(true);
            }
        });
    }
