...
public class EditWorkAddressPage extends javax.swing.JFrame {
    private static String customerName;
    private static String address;
    public EditWorkAddressPage(String customerName) {
        initComponents();
        this.customerName = customerName;
        loadUserHomeAddress();
    }
// Method to load the Work Address for the logged-in user
    private void loadUserHomeAddress() {
        try (BufferedReader reader = new BufferedReader(new FileReader("src/main/resources/txtfile/Users.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                if (line.startsWith("Username: ") && line.substring(10).equals(customerName)) {
                    ...
                    String WorkAddress = line.substring(14); // Extract the Home address value
                    currentAddress.setText(WorkAddress); // Display Home Address
                    break;
                }
            }
        } catch (IOException e) {
    ...
    public void setAddress(String address){
        EditWorkAddressPage.address = address;
    }
    
    public String getAddress(){
        return EditWorkAddressPage.address;
    }
    ...
    String newWorkAddress = newAddressField.getText().trim();
    ...
    if (updateWorkAddressInFile(customerName, newWorkAddress)) {
        JOptionPane.showMessageDialog(this, "Work address updated successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
        currentAddress.setText(newWorkAddress); // Update the displayed current address
    } else {
        JOptionPane.showMessageDialog(this, "Error updating work address.", "Error", JOptionPane.ERROR_MESSAGE);
    }
} 

private boolean updateWorkAddressInFile(String username, String newWorkAddress) {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (line.startsWith("Username: ") && line.substring(10).equals(username)) {
                ...
                writer.write("Work Address: " + newWorkAddress + System.lineSeparator());
                isUpdated = true;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditWorkAddressPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditWorkAddressPage(customerName).setVisible(true);
            }
        });
    }
